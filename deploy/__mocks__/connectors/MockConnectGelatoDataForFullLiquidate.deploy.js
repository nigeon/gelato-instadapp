...
module.exports = async (hre) => {
  if (hre.network.name === "mainnet") {
    console.log(
      "Deploying MockConnectGelatoDataFullLiquidateMaker to mainnet. Hit ctrl + c to abort"
    );
  ...
  if (hre.network.name === "hardhat") {
    ...
    await deploy("MockConnectGelatoDataFullLiquidateMaker", {
      from: deployer,
      args: [
        connectorId,
    ...
    await instaConnectors
      .connect(instaMaster)
      .enable(
        (await ethers.getContract("MockConnectGelatoDataFullLiquidateMaker"))
          .address
      );
    ...
    // the following will only deploy "MockConnectGelatoDataFullLiquidateMaker"
...
module.exports.tags = ["MockConnectGelatoDataFullLiquidateMaker"];
