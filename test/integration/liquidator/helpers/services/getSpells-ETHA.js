...
module.exports = async function (
  ...
  const calculationForFullLiquidation = new GelatoCoreLib.Action({
    addr: contracts.connectGelatoDataFullLiquidateMaker.address,
    data: await hre.run("abi-encode-withselector", {
      abi: (
        await deployments.getArtifact("ConnectGelatoDataFullLiquidateMaker")
      ).abi,
      functionname: "getDataAndCastLiquidation",
      inputs: [vaultAId, constants.ETH],
    }),
