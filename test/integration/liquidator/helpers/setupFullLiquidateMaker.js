...
const getDebtBridgeFromMakerConstants = require("../services/getLiquidateMakerConstants");
...
const getSpellsEthA = require("./services/getSpells-ETHA");
...
module.exports = async function () {
  ...
  const spells = await getSpellsEthA(
    wallets,
    contracts,
    constants,
    vaultAId
